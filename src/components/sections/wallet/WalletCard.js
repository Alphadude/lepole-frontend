...
const WalletCard = ({ item, lastItem }) => {
  
  return (
    <div className='bg-bundle-coin-bg px-2 py-4 rounded-lg' >
      <div className="grid grid-cols-2 gap-x-10">
        ...
        <div>
           <h3 className="text-[32px] font-droid text-primary-white dark:text-primary-white mb-1">
              {item.amount}
            </h3>
          </div>
