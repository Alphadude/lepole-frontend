...
const ExploreBanner = () => {
  return (
    <div className="h-fit xl:h-48  flex lg:items-center xl:items-stretch  justify-between w-full bg-[#E2EFE9] px-2 lg:!px-6 !py-4 rounded-2xl">
      <div className="flex flex-col  justify-between">
        <Heading2 className="text-primary-green text-sm lg:text-lg font-bold">
          Welcome, Doyle
        </Heading2>

        <p className=" text-xs lg:text-base font-medium text-renaissance-black lg:w-2/3">
