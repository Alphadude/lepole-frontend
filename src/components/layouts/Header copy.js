...
const Header = () => {
  ...
  return (
    <div className="bg-primary-white dark:bg-dark-1 flex items-center justify-between !px-4 lg:!px-6 py-4 lg:py-8  lg:border-b border-gray-4 dark:border-dark-1">
      <H1 className="hidden  lg:block font-bold text-lg lg:text-2xl text-renaissance-black dark:text-primary-white">
